		...
		if(time >= '01' && time <= '04') {
			resu = {
				quest : [{
					...
					name: "Rasa Manisan yang Tak Terlupakan",
					req: "BAB 4: Raja Agung Darkan",
                    npc: "Lefina",
                    lv: "210",
					mats: "- Air Mata Burung Gereja 10x (Gity : Hutan Farkoma)\n- Serbuk Jamur 10x (Jamur Medis : Hutan Farkoma)\n- Daun Ingatan 10x (Doctowl : Hutan Farkoma)",
					Boss: "Erkuch",
					element: "Api",
					exp: "- Polos (210): 490.000\n- Kakao (240): 670.000\n- Choco (270): 790.000",
					reward: "Teh Herbal Premium"
				}]
			}	
		} else {
...
*Chapter 1 :  Tempat dan Persembahan Tak Dikenal*
...
*Chapter 2 : Prajurit yang Selamat*
...
*Chapter 3 : Misi Penyelamatan Ksatria Natal*

Q1
Pembasmian 3 boss
*Reward : Boneka salju*

*Chapter 4 : Monster Anti Natal dan Kota Beku*
...
*Chapter 5 : Patung Es Istana Noeliel*

Q1
- Salju suci *5x* (manusia salju : istana noeliel)
*Reward : Berlian noel*

====== Quest Pelulu (kota navida) =========

*Chapter 6 : Petak Umpet di Malam Kudus*
...
*Chapter 7 : Rahasia di Malam Bersalju*

Q1
- Batu sakral *10x* (santaby : paviliun tomte:pintu masuk)
*Reward : Salju kristal*

*Chapter 8 : Krisis di Istana Noeliel Lagi*

Q1
- Emblem kuyu *10x* (all mobs : istana noeliel Lt. B1)
*Reward : Kristal salju suci*

*Chapter 9 : Kericuhan Menukar Balik Kekuatan Suci* (WIP)
- Kotak Curian (Merah) *3x* (Nix : Kota Illuminare)
- Kotak Curian (Biru) *3x* (Snorm : Kota Illuminare)
- Kotak Curian (Hijau) *3x* (Iluminator : Kota Illuminare)
